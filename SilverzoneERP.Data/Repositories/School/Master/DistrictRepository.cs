...
namespace SilverzoneERP.Data
{
    public class DistrictRepository : BaseRepository<District>, IDistrictRepository
    {
        ...
        public bool Exists(string DistrictName, string country, string zone, string state)
        {
            return _dbset.Any(x=>x.DistrictName==DistrictName && x.Country.CountryName==country && x.Zone.ZoneName==zone && x.State.StateName==state);
        }
    }
}
