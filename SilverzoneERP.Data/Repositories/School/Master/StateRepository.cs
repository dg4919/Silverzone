...
namespace SilverzoneERP.Data
{
    public class StateRepository:BaseRepository<State>,IStateRepository
    {
        ...
        public bool Exists(string StateName, string StateCode, string Zone, string Country)
        {
            return _dbset.Any(x=>x.StateName==StateName && x.StateCode==StateCode && x.Zone.ZoneName==Zone && x.Country.CountryName==Country);
        }
    }
}
