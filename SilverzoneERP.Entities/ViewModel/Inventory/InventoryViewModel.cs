...
namespace SilverzoneERP.Entities.ViewModel
{
    ...
    public class orderViewModel
    {
        ...
        public static Dispatch_Master parse(orderViewModel vm)
        {
            ...
            model.Status = true;
            model.OrderSource = vm.sourceType;
        ...
        public static string get_trackUrl(Dispatch x)
        {
            if (x.CourierModeId == null)
                return string.Empty;

            return x.CourierMode.Courier.Id == 4           // create URL for for fedex 
