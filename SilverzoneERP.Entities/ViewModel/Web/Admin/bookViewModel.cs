...
namespace SilverzoneERP.Entities.ViewModel.Admin
{
    ...
    public class bookInfo
    {
        ...
        public decimal Sch_Price { get; set; }
        ...
        public static bookInfo Parse(Book model)
        {
            return new bookInfo()
            {
                ...
                bookImage = image_urlResolver.getBookImage(model.BookImage),
                bookISBN = model.ISBN,
                bookPrice = model.Price,
                Sch_Price=model.Sch_Price,
        ...
        public static Book Parse(bookInfo model)
        {
            return new Book()
            {
                ...
                BookImage = image_urlResolver.parseImage(model.bookImage),
                ISBN = model.bookISBN,
        ...
        public static Book Parse(Book model, bookInfo newModel)
        {
            ...
            model.BookImage = image_urlResolver.parseImage(newModel.bookImage);
            model.ISBN = newModel.bookISBN;
            model.Price = newModel.bookPrice;
            model.Sch_Price = newModel.Sch_Price;
    ...
    public class bundleViewModel
    {
        ...
        public static bundleViewModel Parse(BookBundle model)
        {
            return new bundleViewModel()
            {
                ...
                totalPrice = model.bundle_details.Sum(y => y.book.Price),
                ClassId = model.ClassId
            };
        }
