...
namespace SilverzoneERP.Api.api.School
{
    ...
    public class examDateController : ApiController
    {
        ...
        public examDateController(IExaminationDateRepository _examinationDateRepository, ISchoolRepository _schoolRepository)
        {
        ...
        [HttpGet]
        public IHttpActionResult GetExamDate()
        {
            return Ok(new { ExamDateList = _examinationDateRepository.GetExamDate() });
        }
    }
}
