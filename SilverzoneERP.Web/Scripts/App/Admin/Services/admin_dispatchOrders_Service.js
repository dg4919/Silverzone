(function () {
    ...
    var fn = function ($http, $q, globalConfig, $filter) {
        ...
        function bind_itemList_Html(myHtml, model) {
            ...
            $(html).find('#packetDetail').html('<div style="font-size: 16px;"><p> Invoice Number - <b>' + model.packetInfo.Invoice_No + '</b> </p>'
                                           ...
                                           + '<p>Bar Code - <img src=' + imgSrc + ' style="margin-left: 7px;"> </p></div>');
            ...
            var shipcharge = '<td colspan="6" style="text-align: right;"><strong>Shipping Charges</strong> <div> <strong style="font-size: 75% !important;">'
                           + (model.orderInfo.First_Shipping_Charge === 0 ? '' : '(for first unit @' + model.orderInfo.First_Shipping_Charge + ' and rest @' + model.orderInfo.Other_Shipping_Charge + ' each)') + '</strong></div> </td>'
