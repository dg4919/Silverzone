    ...
    var configFn = function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state("track_order", {
                ...
                templateUrl: 'Templates/Admin/views/dispatch/TrackOrder.html',
            ...
            .state("metaTag", {
                url: '/ERP/Admin/Meta',
                templateUrl: 'Templates/Admin/views/MetaTag.html',
                controller: 'meta_list',
            })
            .state("newsUpdates", {
                url: '/ERP/Admin/NewsUpdates',
                templateUrl: 'Templates/Admin/views/newsUpdates.html',
                controller: 'newsUpdates',
            })
            .state("gallery", {
                 url: '/ERP/Admin/Gallery',
                 templateUrl: 'Templates/Admin/views/gallery/galleryInfo.html',
                 controller: 'gallery',
             })
            .state("Schedule_Olympiad", {
                 url: '/ERP/Admin/Schedule_olympiad',
                 templateUrl: 'Templates/Admin/views/Schedule_Olympiad.html',
                 controller: 'Schedule_olympiad',
             })
            .state("siteConfig", {
                 url: '/ERP/Admin/siteConfig',
                 templateUrl: 'Templates/Admin/views/siteConfiguration.html',
            ...
            .state("InstantDnd_SubjectsMapping", {
                 url: '/ERP/Admin/InstantDnd_SubjectsMapping',
                 templateUrl: 'Templates/Admin/views/InstantDnd_SubjectsMapping.html',
                 controller: 'instantDnd',
             })
            .state("carrierMaster", {
                 url: '/ERP/Admin/Carrier',
                 templateUrl: 'Templates/Admin/views/Carrier.html',
                 controller: 'carrier',
             })
        ;
