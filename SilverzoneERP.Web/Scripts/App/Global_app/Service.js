(function () {
    ...
    var fun = function ($http, $q, globalConfig, localStorageService, $rootScope, $location, $filter, $window, $modal) {
        ...
        fac.Logout = function () {
            ...
            localStorageService.remove('EventYearInfo');
            $rootScope.UserInfo = {};
            $rootScope.IsLeftMenu = true;
            //   prompt('', $window.location);
            var url=$window.location.href;
            if (url.indexOf("?RoleName") == -1) 
    ...
    .factory('Service', ['$http', '$q', 'globalConfig', 'localStorageService', '$rootScope', '$location', '$filter', '$window', fun]);
})();