    ...
    var fun = function ($http, $q, globalConfig, $filter, $uibModal, Service, $rootScope) {
        ...
        fac.Add_Co_Ordinator = function (scope, rootScope,  CoOrdinatorObj) {
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'Templates/School/Olympiad/EventManagement/Partial/Dialog_Co_Ordinator.html',
                backdrop: 'static',
                resolve: {
        ...
        fac.Search = function (scope, rootScope,IsLoad) {
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'Templates/School/Olympiad/SearchSchool/Index.html',
            ...
            Service.Get('school/schManagement/GetSchool?SchCode=' + SchCode + '&EventId=' + evenId)
             .then(function (response) {
                 ...
                 if (response.result != null) {
                     ...
                     if (!angular.isUndefined(scope.Reset_EnrollmentOrder) && scope.Reset_EnrollmentOrder == true)
                         scope.EnrollmentOrder_Change(scope.StudentEntry.EnrollmentOrderId,false);
                 }
                 else {
