...
(function (app) {
    var scm_fun = function ($scope, $rootScope, Service, $filter, $state, $uibModal, $stateParams, SchoolService, localStorageService) {
        $rootScope.HeaderAction = "Templates/School/Olympiad/SchoolManagement/Partial/Header.html";
        $scope.ContactInfo = {};
        ...
        $scope.PinCode_Leave = function () {
            if (angular.isUndefined(response.EventGuid)|| $scope.SchMngt.SchPinCode.length < 6)
                return false;
       ...
       // $scope.SearchBySchoolCode();
        ...
        $scope.Add_Co_Ordinator = function (EventObj, CoOrdinatorObj) {
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'Templates/School/Olympiad/SchoolManagement/Partial/Co_Ordinator.html',
                resolve: {
        ...
        $scope.Add_Address_To = function (AddressObj, IsOtherContact) {
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'Templates/School/Olympiad/SchoolManagement/Partial/AddressTo.html',
                resolve: {
                    items: $scope.Related_Object,
                    AddressTo: data,
                    SchMngt: $scope.SchMngt
        ...
        function ShowSchoolList(data) {
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'Templates/School/Olympiad/SchoolManagement/Partial/SchoolList.html',
                resolve: {
        ...
        $scope.Log = function () {
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'Templates/School/Olympiad/SchoolManagement/Partial/Log.html',
                resolve: {
                    SchId: function () {
