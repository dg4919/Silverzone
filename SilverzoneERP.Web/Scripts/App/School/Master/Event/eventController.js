(function (app) {
    ...
    var desg_fun = function ($scope, $rootScope, $state, Service, globalConfig, $filter) {
        $rootScope.HeaderAction = "Templates/School/Master/Event/Event_Header.html";
        ...
        $scope.Edit = function (data) {
            ...
            $scope.Event = { "Id": data.Id, "EventName": data.EventName, "SubjectName": data.SubjectName, "EventCode": data.EventCode, "RowVersion": data.RowVersion,"EventLater":data.EventLater };
            $scope.isEdit = true;
        }
