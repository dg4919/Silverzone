(function (app) {
    ...
    var cate_fun = function ($scope,$rootScope, $state, Service, globalConfig, $filter) {
        $rootScope.HeaderAction = "Templates/School/Master/Category/Header.html";
    ...
    app.controller('categoryController', ['$scope', '$rootScope', '$state', 'Service', 'globalConfig', '$filter', cate_fun]);
