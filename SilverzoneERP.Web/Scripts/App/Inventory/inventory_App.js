...
(function () {
    var configFn = function ($stateProvider) {
        ...
        //})
         ...
         .state('RC_Schools_Assign', {
            url: '/ERP/RC/assignSchools',
            templateUrl: 'Templates/inventory/RegionalCordinator/schoolAssign.html',
            controller: 'rcSchoolAssign_controller'
        })
         .state('RC_Schools_Visit', {
             url: '/ERP/RC/SchoolVisit',
             templateUrl: 'Templates/inventory/RegionalCordinator/schoolVisits.html',
             controller: 'rcSchoolVisit_controller'
        })
         .state('RC_FollowUps', {
             url: '/ERP/RC/FollowUps',
             templateUrl: 'Templates/inventory/RegionalCordinator/followUps.html',
             controller: 'rcFollowUps_controller'
        })
        ;
    }
